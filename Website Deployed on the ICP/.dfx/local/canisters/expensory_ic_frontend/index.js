...
export const canisterId = process.env.EXPENSORY_IC_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./expensory_ic_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the expensory_ic_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./expensory_ic_frontend.did.js")._SERVICE>}
 */
